	...
	public Canary_Exchange() {
		...
		Vdolar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (input.matches("\\d+")) {
					...
					cambio.setText(String.format("%.2f",cambiom)+ " Euros");
				}else {
		...
		Vrublos.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				    ...
				    try {
				    	valorimporte = Integer.parseInt(importe.getText());
				    	cambiom = valorimporte * rubloss;
		...
		Vyenes.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				int valorimporte;
				double cambiom;
				...
				try {
					valorimporte=Integer.parseInt(importe.getText());
					cambiom=valorimporte * yen;
					cambio.setText(String.format("%.2f", cambiom) + " Euros");
							
				}catch (NumberFormatException ex) {
					cambio.setText("Ingresa un numero valido");
